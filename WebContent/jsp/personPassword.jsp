<%@page import="com.stock.pojo.Personnel"%>
...
<script type="text/javascript">
	$(document).ready(function(){
		var tabTop = "<c:url value='/json/personPassword.json'/>";
		var rowurl = "<c:url value='/personnel/find?mode=1'/>";
		var posturl = "<c:url value='/personnel/save'/>";
		var newRow = "{\"id\":\"\",\"name\":\"\",\"sex\":\"\",\"birthday\":\"\",\"id_card_num\":\"\",\"department_num\":\"\",\"rnum\":\"\",\"remarks\":\"\"}";
		var hidcolumns = "id,birthday,rnum,state,remarks";//隐藏列字段名
		var id = "id";//主键字段名
