...
<link rel="shortout icon" href="<c:url value='/images/logo.ico'/>"  />
...
<%
	...
	<div style="float:left;text-align: right;width: 100%;">
    	<div style="position: fixed; top:0; text-align: right; width: 100%;">
    		<span style="color: blue">当前时间：</span>
    		<span id="dt" style="margin-right: 20px"></span>
    	</div>
    </div>
	<div class="divcenter" align="center">
		<form action="<c:url value='/login/login'/>" method="post">
			<table><br>
				<tr>
					<td colspan="2">
						<img src="<c:url value='/images/logo.png'/>" align="absmiddle" width="180px">
					</td>
				</tr>
				<tr>
					<td height="35px"></td>
				...
				<tr>
					...
					<td><input type="text" id="username" name="personnel.id_card_num" style="height: 30px;width: 200px"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="password"  id="password" name="personnel.password" style="height: 30px;width: 200px"/></td>
				</tr>
				<tr>
